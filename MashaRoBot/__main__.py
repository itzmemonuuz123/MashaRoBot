...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ADD MOLUUZ TO YOUR GROUP ➕️", url="t.me/MashaRoBot?startgroup=true"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="💾 SOURCE", callback_data="Tharoola"),
        InlineKeyboardButton(
            text="👥 SUPPORT", url="https://t.me/moluuzu"
        ),
    ],
]
